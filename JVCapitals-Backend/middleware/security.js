...
class SecurityMiddleware {
	static rateLimiter() {
		return rateLimit({
			...
			max: process.env.NODE_ENV === "production" ? 1000 : 1000, // Increased for multi-user hosting
			message: {
				success: false,
	...
	static strictRateLimiter() {
		return rateLimit({
			...
			max: process.env.NODE_ENV === "production" ? 100 : 50, // Increased for multi-user hosting
			message: {
				success: false,
				error: "Too many requests",
				message:
